    ...
    public class MusicsController : Controller
    {
        ...
        public ActionResult Index()
        {
            if (User.IsInRole("artists"))
            {
                ...
                var data = Crud<Musica>.GetBy("artist", currentUserId);
        ...
        {
            return Enum.GetValues(typeof(Musica.MusicalGenre))
                .Cast<Musica.MusicalGenre>()
        ...
        public ActionResult Create(Musica data, IFormFile MusicFile, int? AlbumId)
        {
            try
            {
                // Validar archivo
        ...
        [RequestFormLimits(MultipartBodyLengthLimit = 50 * 1024 * 1024)]
        public ActionResult Edit(int id, Musica data, IFormFile MusicFile, int? AlbumId)
        {
            try
            {
                ...
                if (MusicFile != null && MusicFile.Length > 0)
                {
                    ...
                    var currentMusic = Crud<Musica>.GetById(id);
        ...
        public ActionResult Search(string query)
        {
            ...
            var allMusicsFiltered = Crud<Musica>.GetAll();
