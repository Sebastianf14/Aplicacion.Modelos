...
using Aplicacion.Models.Favorite;
...
namespace Aplicacion.MVC.Controllers
{
    ...
    public class FavoritesController : Controller
    {
        ...
        public ActionResult AddMusic(int musicId, string returnUrl = null)
        {
            try
            {
                var favorite = new FavoriteMusic
                {
                ...
                Crud<FavoriteMusic>.Create(favorite);
        ...
        public ActionResult RemoveMusic(int musicId, string returnUrl = null)
        {
            try
            {
                ...
                var userFavorites = Crud<FavoriteMusic>.GetBy("user", currentUserId);
        ...
        public ActionResult AddArtist(int artistId, string returnUrl = null)
        {
            try
            {
                ...
                var favorite = new FavoriteArtist
                {
                ...
                Crud<FavoriteArtist>.Create(favorite);
        ...
        public ActionResult RemoveArtist(int artistId, string returnUrl = null)
        {
            try
            {
                ...
                // Obtener favoritos del usuario para encontrar el ID correcto
                var userFavorites = Crud<FavoriteArtist>.GetBy("user", currentUserId);
        ...
        private List<Music> GetFavoriteMusicsFromAPI(int userId)
        {
            try
            {
                var favoriteMusics = Crud<FavoriteMusic>.GetBy("user", userId);
        ...
        private List<User> GetFavoriteArtistsFromAPI(int userId)
        {
            try
            {
                var favoriteArtists = Crud<FavoriteArtist>.GetBy("user", userId);
